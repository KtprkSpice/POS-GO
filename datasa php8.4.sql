...
-- Dumping data for table pos-app.login_activities: ~17 rows (approximately)
REPLACE INTO `login_activities` (`id`, `user_id`, `session_id`, `action`, `ip_address`, `user_agent`, `created_at`) VALUES
	...
	(13, 9, 7, 'login', '[::1]:55701', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-14 12:41:39'),
	(14, 2, 8, 'login', '[::1]:50084', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-19 13:56:27'),
	(15, 2, 9, 'login', '[::1]:50395', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-19 14:32:12'),
	(16, 2, 10, 'login', '[::1]:50461', 'Mozilla/5.0 (Linux; Android 15; Pixel 9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Mobile Safari/537.36', '2026-06-19 14:34:17'),
	(17, 9, 11, 'login', '[::1]:50582', 'Mozilla/5.0 (Linux; Android 15; Pixel 9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Mobile Safari/537.36', '2026-06-19 14:36:54'),
	(18, 2, 12, 'login', '[::1]:50593', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-19 14:39:30'),
	(19, 2, NULL, 'failed', '[::1]:50231', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-20 09:13:39'),
	(20, 2, 13, 'login', '[::1]:50231', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-20 09:13:43'),
	(21, 9, 14, 'login', '[::1]:50732', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-20 10:13:13'),
	(22, 2, 15, 'login', '[::1]:50732', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-20 10:16:56');
...
CREATE TABLE IF NOT EXISTS `product_sample` (
  ...
  `status` enum('pending','approved','rejected','shipped','recived') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'pending',
  ...
  KEY `FK_product_sample_users_3` (`reviewer_id`),
  ...
  CONSTRAINT `FK_product_sample_users_3` FOREIGN KEY (`reviewer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table pos-app.product_sample: ~2 rows (approximately)
REPLACE INTO `product_sample` (`id`, `product_name`, `supplier_id`, `reciver_id`, `status`, `recived_at`, `reviewer_id`, `review_note`, `review_date`, `description`, `submission_date`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Kopi Gadjah Madhja', 9, 2, 'recived', '2026-06-20 10:20:23', NULL, NULL, NULL, 'We can swim in an ocean of rainbows and trees\r\nNothing here makes sense but you and me\r\nDon\'t think about it just follow my lead ooh (ha ha)', '2026-06-20 10:16:45', '2026-06-11 11:22:08', '2026-06-11 11:22:08', NULL),
	(2, 'daw', 9, 2, 'rejected', '2026-06-19 16:46:22', 2, 'dawd', '2026-06-20 09:47:59', 'sad', '2026-06-14 13:14:54', '2026-06-14 10:07:51', '2026-06-14 10:07:51', NULL);
...
-- Dumping data for table pos-app.sessions: ~15 rows (approximately)
REPLACE INTO `sessions` (`id`, `user_id`, `token`, `ip_address`, `user_agent`, `expires_at`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(7, 9, 'd6d6fa80-ab85-43ad-a912-e7d2a0e00d2a', '[::1]:55701', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-15 05:41:40', '2026-06-14 12:41:39', '2026-06-14 12:41:39', NULL),
	(8, 2, 'd8eecd5b-20dc-4db6-b981-f1f1ebc05b4a', '[::1]:50084', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-20 06:56:27', '2026-06-19 13:56:26', '2026-06-19 13:56:26', NULL),
	(9, 2, 'cb7f6a32-e4c0-44fc-95a0-aa794c42b9db', '[::1]:50395', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-20 07:32:12', '2026-06-19 14:32:12', '2026-06-19 14:32:12', NULL),
	(10, 2, 'af1d7a05-a6fd-44b4-a30d-c3a443704d39', '[::1]:50461', 'Mozilla/5.0 (Linux; Android 15; Pixel 9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Mobile Safari/537.36', '2026-06-20 07:34:18', '2026-06-19 14:34:17', '2026-06-19 14:34:17', NULL),
	(11, 9, '10d8837c-c62b-4c92-8e10-e1a40d39809e', '[::1]:50582', 'Mozilla/5.0 (Linux; Android 15; Pixel 9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Mobile Safari/537.36', '2026-06-20 07:36:55', '2026-06-19 14:36:54', '2026-06-19 14:36:54', NULL),
	(12, 2, 'ac8b4342-14f3-4c22-956b-dd4ef2a564a9', '[::1]:50593', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-20 07:39:31', '2026-06-19 14:39:30', '2026-06-19 14:39:30', NULL),
	(13, 2, '4d66224d-1b31-4df8-9d08-de21c89a587c', '[::1]:50231', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-21 09:13:44', '2026-06-20 09:13:43', '2026-06-20 09:13:43', NULL),
	(14, 9, '42469de7-f40b-4baa-9f26-11ff24c280c9', '[::1]:50732', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-21 10:13:14', '2026-06-20 10:13:13', '2026-06-20 10:13:13', NULL),
	(15, 2, '13a0fa8f-5cc5-4d56-8516-49cd1c421cd8', '[::1]:50732', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '2026-06-21 10:16:57', '2026-06-20 10:16:56', '2026-06-20 10:16:56', NULL);
...
CREATE TABLE IF NOT EXISTS `suppliers` (
  ...
  `phone` varchar(100) NOT NULL,
  `wallet_address` varchar(100) NOT NULL,
  `vendor_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `vendor_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `user_id` bigint NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
REPLACE INTO `suppliers` (`id`, `phone`, `wallet_address`, `vendor_name`, `vendor_address`, `user_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
